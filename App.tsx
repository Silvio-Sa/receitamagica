  ...
  return (
    <div style={{
      ...
      >
        ...
        <br />
        <span style={{ color: "#818cf8", fontWeight: 600 }}>Evite desperdícios, cozinhe com criatividade e surpreenda-se!</span>
      </motion.p>
      <div style={{
        ...
        <div style={{
          ...
          <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
            <path stroke="#818cf8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" d="M7 2v20M5 5c0 2 1.5 4 3 4s3-2 3-4M19 2l-2 9h4l-2 9" />
          </svg>
          <h2 style={{
            fontSize: "1.5rem",
            color: "#fff",
        ...
        <input
          ...
          onKeyDown={e => { if (e.key === "Enter") handleRecipeRequest(); }}
          disabled={loading}
        />
        <button
          style={{
        ...
        >
          ...
          <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
            <path stroke="#fff" strokeWidth="2" strokeLinecap="round" d="M12 3v2m0 14v2m9-9h-2M5 12H3m13.31-6.31l-1.42 1.42M6.1 17.9l-1.42 1.42m0-12.02l1.42 1.42m10.8 10.8l1.42 1.42" />
          </svg>
          Gerar Receita
        </button>
        <div style={{
      ...
      >
        <span style={{ color: "#818cf8", fontWeight: 600 }}>Quais ingredientes você tem aí?</span> Me diga para eu preparar uma receita gostosa pra você.
      </motion.p>
    </div>
  );
}
